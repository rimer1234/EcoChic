...
function ShowCards()
{
    ...
    for (let i = 0; i < w_img.length && i < 8; i++)
    {
        ...
        children[2].innerHTML = "CO2: " + w_c[i] + "<br>Energy: " + w_e[i] +"<br>Eutrophy: " + w_eut[i] + "<br>Water: " + w_w[i] + "<br>Chemistry: "+ w_chem[i] + "<br>Higg MSI: "+ msi;
...
function updateChart()
{
    ...
    var lmsi = Math.round(tmsi / n);
      // data set
        ...
        chart1.title("Higgs MSI Score: " + String(lmsi));

        document.getElementById("result").innerHTML = "Your Wardrobe's Higgs MSI Score: " + String(lmsi);
        if (lmsi <= 40)
